...
export const LogTemplates = {
  ...
  REDUCTION_LIST_START: 'Reduction list start user_id={userId}',
  REDUCTION_CREATE_START: 'Reduction[user_id={userId}] create start measure={measure} record_date={recordDate}',
  REDUCTION_CREATE_SUCCESS: 'Reduction[id={id}] create success reduction_value={reductionValue}',
  REDUCTION_CREATE_FAILED: 'Reduction[id={id}] create failed: {field} {reason}',
  REDUCTION_UPDATE_START: 'Reduction[id={id}] update start fields={fields}',
  REDUCTION_UPDATE_SUCCESS: 'Reduction[id={id}] update success reduction_value={reductionValue} record_date={recordDate}',
  REDUCTION_UPDATE_FAILED: 'Reduction[id={id}] update failed: {field} {reason}',
  REDUCTION_DELETE_SUCCESS: 'Reduction[id={id}] delete success',
  REDUCTION_SUMMARY_CALCULATED: 'Reduction[user_id={userId}] summary calculated total={total} range={start}~{end}',
