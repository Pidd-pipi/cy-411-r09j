export const Messages = {
  ...
  REDUCTION_CREATED: 'Reduction measure recorded in abatement ledger',
  REDUCTION_UPDATED: 'Reduction measure adjusted and totals re-aggregated by date',
  REDUCTION_DELETED: 'Reduction measure removed from abatement ledger',
