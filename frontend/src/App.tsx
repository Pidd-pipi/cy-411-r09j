...
import { AuditOutlined, BarChartOutlined, FlagOutlined, LogoutOutlined, OrderedListOutlined, SafetyOutlined, TeamOutlined, UserOutlined } from '@ant-design/icons';
...
const navItems = [
  ...
  { key: '/reductions', icon: <SafetyOutlined />, label: '减排台账' },
