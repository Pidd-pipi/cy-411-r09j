...
import { AuditOutlined, BarChartOutlined, FlagOutlined, LogoutOutlined, OrderedListOutlined, TeamOutlined, UserOutlined, VerticalAlignBottomOutlined } from '@ant-design/icons';
...
const navItems = [
  ...
  { key: '/reductions', icon: <VerticalAlignBottomOutlined />, label: '减排台账' },
