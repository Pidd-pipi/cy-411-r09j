export const Messages = {
  ...
  FRONTEND_REDUCTION_SAVED: '减排措施已登记到减排台账',
  FRONTEND_REDUCTION_UPDATED: '减排记录已调整，按新日期重新汇总',
  FRONTEND_REDUCTION_DELETED: '减排记录已移除，汇总已刷新',
  FRONTEND_REDUCTION_DUPLICATE: '同一人同一天同一措施只能登记一条',
