export const Messages = {
  ...
  FRONTEND_REDUCTION_SAVED: '减排措施已登记到台账',
  FRONTEND_REDUCTION_UPDATED: '减排记录已调整，将按新日期重新汇总',
  FRONTEND_REDUCTION_DELETED: '减排记录已从台账移除',
  FRONTEND_REDUCTION_DUPLICATE: '同一天同一措施只能登记一条',
  ...
  LOG_REDUCTION_MEASURE: 'Reduction measure affects ledger unique key, dashboard net emissions, logs and errors'
} as const;
